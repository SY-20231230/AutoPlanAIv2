...
이제 이 정보를 바탕으로, 기능 명세 목록을 수정 및 추가하고 더 깔끔하고 명확한 구조의 **최종 기획서 문서**를 작성하십시오.
...
- 출력 마지막에 입력 받은 기획서 원문과 기능 명세 목록에서 수정된 사항을 정리
- 기획서와 기존 유사 기능 어플들과의 차이점 (실제 사용 중인 어플을 찾고 설명 및 비교)
- 입력 받은 기획서를 참고하여 GitHub나 구글에서 유사하거나 관련된 오픈소스 프로젝트를 찾아줘 . 각 프로젝트는 다음 정보를 포함해줘:

1. 프로젝트명
2. GitHub 링크
3. 주요 기능 요약
4. Star 수
5. 어떤 점이 내 기획서와 유사한지 설명
